...
class FmProductFetch extends FyndiqPaginatedFetch
{
    ...
    {
        $this->FmProductHelper = new FmProductHelper();
    }
    ...
    public function processData($data)
    {
        ...
        foreach ($data as $statusRow) {
            ...
            $result &= $this->FmProductHelper->updateStatus($statusRow->product_id, $status);
        }
        return $result;
    }
    ...
    {
        $this->FmProductHelper->updateStatusAllProducts(FmProductHelper::STATUS_PENDING);
